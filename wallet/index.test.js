    ...
    describe('creating a transaction', () => {
        ...
        describe(' and doing the same transaction', () => {
            beforeEach(() => {
                ...
                wallet.createTransaction(recipient, sendAmount,
                    transactionPool);
            });
            ...
            it('clones the `sendAmount`output for the transaction ', () => {
                // filter will return only those items that satisfy the
                condition
                ...
                expect(transaction.outputs.filter(output => output.address ===
                    recipient).map(output => output.amount)).toEqual([sendAmount,
                        sendAmount]);
            });
        });
    });
